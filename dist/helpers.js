...
exports.formatSwaps = exports.normalizePools = exports.sortPoolsMostLiquid = exports.filterPools = exports.parsePoolData = exports.getNormalizedLiquidity = exports.updateTokenBalanceForPool = exports.EVMgetOutputAmountSwap = exports.EVMgetOutputAmountSwapForPath = exports.parsePoolPairDataForPath = exports.parsePoolPairData = exports.getHighestLimitAmountsForPaths = exports.getDerivativeSpotPriceAfterSwapForPath = exports.getDerivativeSpotPriceAfterSwap = exports.getSpotPriceAfterSwapForPath = exports.getSpotPriceAfterSwap = exports.getEffectivePriceSwapForPath = exports.getOutputAmountSwapForPath = exports.getOutputAmountSwap = exports.getLimitAmountSwapForPath = exports.getLimitAmountSwap = void 0;
...
const weightedSolidity = __importStar(
    require('./solidityHelpers/pools/weighted')
);
const FixedPoint_1 = require('./solidityHelpers/math/FixedPoint');
        ...
        if (poolType == 'Weighted') {
            ...
            if (pairType == 'token->token') {
                returnAmount = weightedSolidity._outGivenIn(
                    new FixedPoint_1.FixedPoint(
                        bmath_1.scale(balanceIn, decimalsIn)
                    ),
                    new FixedPoint_1.FixedPoint(bmath_1.scale(weightIn, 18)),
                    new FixedPoint_1.FixedPoint(
                        bmath_1.scale(balanceOut, decimalsOut)
                    ),
                    new FixedPoint_1.FixedPoint(bmath_1.scale(weightOut, 18)),
                    new FixedPoint_1.FixedPoint(
                        bmath_1.scale(amount, decimalsIn)
                    ),
                    new FixedPoint_1.FixedPoint(bmath_1.scale(swapFee, 18))
                );
                ...
                returnAmount = weightedSolidity._exactTokenInForBPTOut(
                    ...
                    new FixedPoint_1.FixedPoint(bmath_1.scale(balanceOut, 18)), // BPT is always 18 decimals
                    new FixedPoint_1.FixedPoint(bmath_1.scale(swapFee, 18))
                );
                // TODO: scaling down may not be necessary since we have to
                // scale it up anyways for the swap info later?
                ...
                returnAmount = weightedSolidity._exactBPTInForTokenOut(
                    ...
                    new FixedPoint_1.FixedPoint(bmath_1.scale(weightOut, 18)),
                    new FixedPoint_1.FixedPoint(bmath_1.scale(amount, 18)), // BPT is always 18 decimals
                    new FixedPoint_1.FixedPoint(bmath_1.scale(balanceIn, 18)), // BPT is always 18 decimals
                    new FixedPoint_1.FixedPoint(bmath_1.scale(swapFee, 18))
                );
                // TODO: scaling down may not be necessary since we have to
                // scale it up anyways for the swap info later?
        ...
        if (poolType == 'Weighted') {
            ...
            if (pairType == 'token->token') {
                returnAmount = weightedSolidity._inGivenOut(
                    ...
                    new FixedPoint_1.FixedPoint(bmath_1.scale(weightOut, 18)),
                    new FixedPoint_1.FixedPoint(
                        bmath_1.scale(amount, decimalsOut)
                    ),
                    new FixedPoint_1.FixedPoint(bmath_1.scale(swapFee, 18))
                );
                // TODO: scaling down may not be necessary since we have to
