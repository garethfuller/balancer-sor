...
exports.calcTotalReturn = exports.smartOrderRouter = exports.filterPaths = exports.processPaths = exports.MAX_UINT = void 0;
...
function iterateSwapAmounts(
    ...
    let priceErrorTolerance = bmath_1.bnum(0.00001); // 0.001% of tolerance -> this does not change much execution time as convergence is fast
    ...
    for (let i = 0; i < swapAmounts.length; ++i) {
        if (swapAmounts[i].isZero()) {
            ...
            const epsilon = totalSwapAmount.times(
                bmath_1.bnum(Math.pow(10, -6))
            );
